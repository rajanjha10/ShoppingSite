...
<html>
    <head>
        ...
        <title>RHS Shopping Store</title>
        <meta charset="UTF-8">
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=1";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=2";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=3";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=4";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=5";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=6";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=7";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=8";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=9";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=10";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <p>Price: Rs. 900.00</p>
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=11";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
                        ...
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    ...
                                    <?php
                                    $seller_query="select name,quantity from seller where item_id=12";
                                    $seller_result=mysqli_query($con,$seller_query) or die(mysqli_error($con));
                                    $row=mysqli_fetch_array($seller_result); ?>
                                    <p>Seller: <?php echo $row['name'] ?></p>
                                    <p>Available: <?php echo $row['quantity'] ?></p>
